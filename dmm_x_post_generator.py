...
COPY_TEMPLATES = [
    # ――― 読後の変化（読む前/後の変化を明示）＋感情 ―――
    "🔥 見る前は「また普通のやつか」と思ってたのに、気づいたら最後まで一気見してた作品",
    "😳 正直期待してなかったけど、サムネ見た瞬間ゾクッとして即クリックした",
    "💦 見終わったあと、しばらく余韻が抜けなかった。それくらい刺さった一本",
    "🌙 仕事で疲れている人に読んでほしい。見終わったあと不思議とスッキリする",
    "😤 「どうせ似たようなやつ」って思ってる人ほど見てほしい。スカッとするから",
    "🎯 毎日チェックしてる自分でも「これは当たりだ」とテンション上がった一本",
    "✨ 見る前と見た後で、同ジャンルへの見る目が変わった気がする作品",
    "😮 サンプルの時点でもうゾクッとした。本編はもっとよかった",
    # ――― ターゲットを絞る（具体的な人に語りかける）―――
    "📌 深夜に一人でゆっくり過ごしたい人に向けて厳選した今夜の一本",
    "🛋️ 仕事終わりにビールでも飲みながら見てほしい、今日イチのおすすめ",
    "🔍 「ハズレを引きすぎて疲れた」という人こそフォローしてほしい理由がこれ",
    "💡 自分で探す時間がもったいない人向けに毎日厳選して投稿してます",
    "😴 寝る前にスマホで手軽に楽しみたい人にちょうどいい尺と内容の作品",
    "👀 同人系が好きな人なら絶対に後悔しない内容。ジャンル好きほど刺さる",
    # ――― 擬音・感嘆符で臨場感 ―――
    "⚡ 見た瞬間「あ、これだ」ってビビッときた。久々にそう感じた一本",
    "💥 クオリティに思わず「うわ…」って声が出た。それくらいのレベル感",
    "🎬 サンプルだけでも伝わる。本編はさらに上を行く",
    "⭐ フォロワーさんに損させたくないので自信を持っておすすめできる一本",
]
...
_OPENERS = [
    "見終わったあとに「これは当たりだった」と思えた理由は",
    "仕事で疲れている人に特に刺さると思ったポイントは",
    "「またハズレか」と思ってる人の期待を裏切ってくれたのは",
    "ゾクッときた要素を挙げるとすると",
]
_CLOSERS = [
    "フォローしてると毎日こういう厳選情報が届きます🔥",
    "サンプルでも雰囲気確認できます👀 まず見てみて",
    "気になった方は早めにチェックを📌 後悔させません",
    "ハズレなしを目指して厳選してます✅ 信頼してほしい",
]
_FALLBACK_PHRASES = [
    "新着をくまなくチェックして「これだ」と感じた今日の一本",
    "見る前と後で印象が変わる、それくらい完成度が高い作品",
    "自信を持っておすすめできる厳選作。ゾクッとした",
]
# データ項目（レビュー・出演者・メーカー）だけでは文字数に余白が出る場合に、
# 商品個別の事実とは無関係な汎用フレーズで埋めるための候補。誇張・断定は避ける。
_FILLER_PHRASES = [
    "サンプル動画でも雰囲気を確認してから買える",
    "深夜に一人でじっくり楽しみたい人向けの内容",
    "仕事終わりに見るのにちょうどいい尺と完成度",
