...
COPY_TEMPLATES = [
    # ――― キュレーター目線（「厳選している人」らしさを前面に） ―――
    "🔍 新着を全部チェックして、これだけは外せないと思った一本です",
    "📌 毎日チェックしている中でも、これは即フォルダ保存した作品",
    "👀 何本も見比べて選んだ今週イチオシがこちら",
    "✅ ハズレを引きたくない人はフォローしておくと手間が省けます",
    "🎯 素人系が好きなら絶対に見ておくべき一本を厳選しました",
    "💡 自分で探す時間もったいない人向けに毎日厳選して投稿してます",
    "🏆 数百本の中から「これは当たり」と判断したものだけ上げてます",
    "🔥 新着チェックしていてテンションが上がった作品をシェア",
    "⭐ フォロワーさんに損させたくないので自信を持っておすすめできる一本",
    "📊 クオリティ・内容・価格のバランスが三拍子そろった神作品",
    # ――― 深夜・シチュエーション訴求 ―――
    "🌙 深夜のお供に最適な一本を今日も厳選しました",
    "🛋️ 仕事終わりにじっくり堪能してほしい今日のおすすめ",
    "📱 スマホで寝ながら見るのにちょうどいい尺と内容",
    # ――― 価格・お得感訴求 ―――
    "💸 このクオリティでこの価格はお得すぎる…即決しました",
    "⏰ セール対象かもしれないので早めのチェックをおすすめします",
    "🎁 ポイント使えばさらにお得。節約しながら楽しみたい方にも",
    # ――― ジャンルファン訴求 ―――
    "🏠 素人系・ハイビジョン好きなら絶対に後悔しない内容です",
    "📸 撮影クオリティが高くて最後まで飽きずに見られた作品",
    "💕 見ていて自然と引き込まれる雰囲気がとにかくよかった",
    "🎬 サンプルだけでも雰囲気伝わる。本編はさらにいいです",
]
...
_OPENERS = ["個人的な推しポイントは", "選んだ理由は", "注目したのは", "ここが刺さった："]
_CLOSERS = ["フォローしてると毎日こういう情報が届きます🔥", "サンプルでも雰囲気確認できます👀", "気になった方は早めにチェックを📌", "ハズレなしを目指して厳選してます✅"]
_FALLBACK_PHRASES = [
    "新着をくまなくチェックして選んだ今日の一本",
    "クオリティと内容のバランスが取れた注目作品",
    "自信を持っておすすめできる厳選作",
]
